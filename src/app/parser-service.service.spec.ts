 ...
 it('should not parse the file if signature is not correct',inject([ParserService],(service:ParserService)=>{
  ...
  it('should return list of cues in which given time is between the start time and end time ',inject([ParserService],(service:ParserService)=>{
    service.cues=[
      ...
      {id: null, subtitle: "It has shed much innocent blood.", startDuration: 109.8, endDuration: 115.8},
    ...
    let cue = service.getCueForTime(110);
    expect(cue).toEqual([{id: null, subtitle: "This blade has a dark past.", startDuration: 107.25, endDuration: 110.5},{id: null, subtitle: "It has shed much innocent blood.", startDuration: 109.8, endDuration: 115.8}]);
  }));
